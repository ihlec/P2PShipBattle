export const CONFIG = {
    ...
    MINIMAP: {
        ...
        RANGE_TILES: 48,
        PING_MS: 6000,
        PING_COOLDOWN_MS: 800
    },

    WORKER: {
        HP: 50,
        SPEED: 1.5,
        GATHER_INTERVAL: 2000,
        GATHER_DAMAGE: 15
    }
};
...
export const TILES = {
    ...
    CROP_SEED:    { id: 50, color: '#2d5e1e', solid: false, name: 'Seedling', short: 'Sdl', hp: 10 },
    CROP_GROWING: { id: 51, color: '#3d7e2e', solid: false, name: 'Growing Crop', short: 'Grw', hp: 10 },
    CROP_READY:   { id: 52, color: '#8fbc3f', solid: false, name: 'Mature Crop', short: 'Rdy', hp: 10 },
    ...
    WORKER: { id: 60, color: '#DEB887', solid: false, name: 'Worker', short: 'Wrk' },
    FURNACE: { id: 61, color: '#8B4500', solid: true, name: 'Furnace', short: 'Fnc', hp: 100 },
...
export const BLUEPRINTS = [
    ...
    { name: "Worker", structure: [{x:0, y:0, id: TILES.WORKER.id}], cost: { [TILES.GOLD.id]: 3 }, special: 'worker' },
    { name: "Furnace", structure: [{x:0, y:0, id: TILES.FURNACE.id}], cost: { [TILES.GREY.id]: 10, [TILES.WOOD.id]: 5 } }
];
